...
namespace ViSD
{
        ...
        public sealed class IncrementalSearch : ITextAreaInputHandler
        {
                ...
                void ITextAreaInputHandler.Attach()
                {
                        ...
                        HistoryIdx = ViSDGlobalWordSearch.History.Count;
                ...
                {
                        string resourceName = "ViSD.Resources.IncrementalSearchCursor.cur";
                        if (direction == LogicalDirection.Backward) {
                                resourceName = "ViSD.Resources.ReverseIncrementalSearchCursor.cur";
                        }
